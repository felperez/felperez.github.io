...
date: 2020-02-06
permalink: /posts/2020/01/blog-post-28/
tags:
  - Probability theory
  - Measure theory
  - Statistical laws
...
$$
\ell(m_1,\dots,m_n| \mu,\sigma,\xi = 0)  = -m\log\sigma - \sum_{k=1}^n \left( \dfrac{m_k - \mu}{\sigma} \right) - \sum_{k=1}^n \exp\left[ -\left(\dfrac{m_k-\mu}{\sigma} \right)\right] .
$$
