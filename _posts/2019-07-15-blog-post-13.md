...
$$
\limsup_{n \to \infty} \dfrac{1}{n} \log \mathbb{P}\{\frac{1}{n} S_{n} \geq x\} \leq -\lambda n x + \limsup_{n \to \infty} \dfrac{1}{n} \log \mathbb{E}(e^{\lambda S_n}) = -\lambda n x  + \varphi(\lambda)
$$
