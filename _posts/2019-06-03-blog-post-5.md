...
$$
\dfrac{|P\phi(x)-P\phi(y)|}{|x-y|}\leq \dfrac{\frac{1}{2}|\phi(\dfrac{x}{2})-\phi(\dfrac{y}{2})|+\frac{1}{2}|\phi(\dfrac{x+1}{2}) - \phi(\dfrac{y+1}{2})|}{|x-y|}
$$
$$
\leq \dfrac{\frac{1}{4}\left( \frac{|f(\frac{x}{2})-f(\frac{y}{2})|}{|x-y|} + \frac{|f(\frac{x+1}{2})-f(\frac{y+1}{2})|}{|x-y|} \right)
$$
