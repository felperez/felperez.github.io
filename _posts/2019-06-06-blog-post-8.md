...
We may suppose that the observables are centered (see remark above).  For $\phi\in\mathcal{B}$, there are $c\_\phi\in\mathbb{C}$ and $\phi_H\in H$ such that $\phi = c\_\phi f + \phi_H$. Then,
